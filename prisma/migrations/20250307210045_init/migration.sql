...
-- CreateEnum
CREATE TYPE "VetConsultationStatus" AS ENUM ('Pending', 'Approved', 'Rejected', 'Completed');
...
CREATE TABLE "VetConsultation" (
    ...
    "status" "VetConsultationStatus" NOT NULL DEFAULT 'Pending',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "VetConsultation" ADD CONSTRAINT "VetConsultation_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VetConsultation" ADD CONSTRAINT "VetConsultation_petId_fkey" FOREIGN KEY ("petId") REFERENCES "Pet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
